...
Public Class Form1
    Private Sub create_button_Click(sender As Object, e As EventArgs) Handles create_button.Click
        ...
        Dim font1 As iTextSharp.text.Font = FontFactory.GetFont(iTextSharp.text.Font.FontFamily.COURIER.ToString(), 20, iTextSharp.text.Font.BOLD)
        Dim font2 As iTextSharp.text.Font = FontFactory.GetFont(iTextSharp.text.Font.FontFamily.COURIER.ToString(), 13, iTextSharp.text.Font.BOLD)
        Dim font3 As iTextSharp.text.Font = FontFactory.GetFont(iTextSharp.text.Font.FontFamily.TIMES_ROMAN.ToString(), 10)
        Dim font4 As iTextSharp.text.Font = FontFactory.GetFont(iTextSharp.text.Font.FontFamily.TIMES_ROMAN.ToString(), 10, iTextSharp.text.Font.BOLD)
        Dim font5 As iTextSharp.text.Font = FontFactory.GetFont(iTextSharp.text.Font.FontFamily.TIMES_ROMAN.ToString(), 7)
        ...
        Dim homeAddress As Paragraph = New Paragraph(vbLf & resumeout.Home_Address, font3)
        Dim emailAddress As Paragraph = New Paragraph(resumeout.Email_Address, font3)
        Dim contactNum As Paragraph = New Paragraph(resumeout.Contact_num, font3)
        ...
        Dim elementary As Phrase = New Phrase("          Elementary             " & resumeout.Elementary & vbLf, font3)
        Dim strHeader As Paragraph = New Paragraph(resumeout.Str_Header & vbLf & vbLf, font2)
        Dim str1 As Paragraph = New Paragraph(vbLf & "        • " & resumeout.Str1 & vbLf, font4)
        Dim str2 As Paragraph = New Paragraph("        • " & resumeout.Str2 & vbLf, font4)
        Dim str3 As Paragraph = New Paragraph("        • " & resumeout.Str3 & vbLf, font4)
        Dim str4 As Paragraph = New Paragraph("        • " & resumeout.Str4 & vbLf & vbLf, font4)
        Dim wknHeader As Paragraph = New Paragraph(resumeout.Wkn_Header & vbLf & vbLf, font2)
        Dim wkn1 As Paragraph = New Paragraph(vbLf & "        • " & resumeout.Wkn1 & vbLf, font4)
        Dim wkn2 As Paragraph = New Paragraph("        • " & resumeout.Wkn2 & vbLf, font4)
        Dim wkn3 As Paragraph = New Paragraph("        • " & resumeout.Wkn3 & vbLf, font4)
        Dim wkn4 As Paragraph = New Paragraph("        • " & resumeout.Wkn4 & vbLf & vbLf & vbLf, font4)
